...
background_image = pygame.image.load("night_sky.jpg")
...
player_image = pygame.image.load("blue_ufo.png")
...
inverted_pillar_image = pygame.image.load("inverted_pillar.png")
